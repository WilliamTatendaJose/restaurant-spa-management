    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl p-8 max-w-3xl w-full max-h-[90vh] overflow-y-auto shadow-3xl border border-emerald-100">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl">
            <Calendar className="h-8 w-8 text-white" />
          </div>
          <h3 className="text-4xl font-light text-gray-800 mb-3">
            Book Your <span className="text-emerald-700">Experience</span>
          </h3>
          <div className="w-16 h-px bg-gradient-to-r from-emerald-500 to-amber-500 mx-auto mb-4"></div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="customer_name" className="text-gray-800">Full Name *</Label>
                  <Input
                    id="customer_name"
                    name="customer_name"
                ...
                <div className="space-y-2">
                  <Label htmlFor="customer_phone" className="text-gray-800">Phone Number *</Label>
                  <Input
                    id="customer_phone"
                    name="customer_phone"
              ...
              <div className="space-y-2">
                <Label htmlFor="customer_email" className="text-gray-800">Email Address *</Label>
                <Input
                  id="customer_email"
                  name="customer_email"
                  type="email"
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="booking_type" className="text-gray-800">Experience Type *</Label>
                <Select
                ...
                >
                  <SelectTrigger id="booking_type" className="border-gray-300 focus:border-emerald-700 focus:ring-2 focus:ring-emerald-700/20 text-gray-800 bg-white">
              ...
              {formData.booking_type === "spa" ? (
                <div className="space-y-2">
                  <Label htmlFor="service" className="text-gray-800">Select Treatment *</Label>
                  <Select
                    ...
                    disabled={!!preselectedService}
                  >
                    <SelectTrigger id="service" className="border-gray-300 focus:border-emerald-700 focus:ring-2 focus:ring-emerald-700/20 text-gray-800 bg-white">
                  ...
                  {selectedService && (
                    <div className="mt-2 p-3 bg-emerald-50 border border-emerald-200 rounded-md">
                      <div className="flex justify-between">
                        <span className="text-sm text-emerald-700 font-medium">Selected treatment:</span>
                        <span className="text-sm text-gray-700 font-medium">{selectedService.name}</span>
                      </div>
                      <div className="flex justify-between mt-1">
                        <span className="text-sm text-emerald-700">Duration:</span>
                        <span className="text-sm text-gray-700">{selectedService.duration} minutes</span>
                      </div>
                      <div className="flex justify-between mt-1">
                        <span className="text-sm text-emerald-700">Price:</span>
                        <span className="text-sm text-gray-700">${selectedService.price}</span>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  <Label htmlFor="party_size" className="text-gray-800">Number of Guests *</Label>
                  <Select
                  ...
                  >
                    <SelectTrigger id="party_size" className="border-gray-300 focus:border-emerald-700 focus:ring-2 focus:ring-emerald-700/20 text-gray-800 bg-white">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="space-y-2">
                  <Label htmlFor="booking_date" className="text-gray-800">Preferred Date *</Label>
                  <Input
                    id="booking_date"
                    name="booking_date"
                    type="date"
                ...
                <div className="space-y-2">
                  <Label htmlFor="booking_time" className="text-gray-800">Preferred Time *</Label>
                  <Input
                    id="booking_time"
                    name="booking_time"
                    type="time"
              ...
              <div className="space-y-2">
                <Label htmlFor="notes" className="text-gray-800">Special Requests (Optional)</Label>
                <Textarea
                  id="notes"
                  name="notes"
          ...
          <div className="flex gap-4 pt-6">
            <Button
              ...
              className="flex-1 py-4 text-lg border-2 border-emerald-300 hover:border-emerald-400 text-emerald-800 hover:bg-emerald-50"
            >
            ...
            <Button
              type="submit"
              disabled={isSubmitting}
              className="flex-1 py-4 text-lg bg-gradient-to-r from-emerald-700 to-emerald-800 hover:from-emerald-800 hover:to-emerald-900 text-white shadow-xl hover:shadow-emerald-600/25"
            >
              {isSubmitting ? (
                <>
