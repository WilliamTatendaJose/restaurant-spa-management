...
export function MenuItemEditor({
  ...
  const [menuItem, setMenuItem] = useState<any>(initialMenuItem);
  const [isLoading, setIsLoading] = useState(!initialMenuItem);
  ...
  useEffect(() => {
    if (!initialMenuItem) {
      async function fetchMenuItem() {
        try {
          setIsLoading(true);
          const itemData = await menuItemsApi.get(id);
    ...
    <div className='container mx-auto px-4 py-6'>
      <div className='flex items-center justify-between'>
        <PageHeader
          ...
          subheading='Update menu item details and pricing'
        />
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    ...
                    the menu item "{menuItem.name}" from your restaurant menu.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
