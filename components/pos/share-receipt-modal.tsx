...
export function ShareReceiptModal({
  ...
  const uploadReceiptPdf = async (): Promise<string> => {
    try {
      ...
      formData.append(
        'file',
        new File([pdfBlob], `receipt-${transactionId.substring(0, 8)}.pdf`, {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='sm:max-w-[425px]'>
              ...
              <div className='grid gap-2'>
                ...
                {customer ? (
                  <p className='text-xs text-muted-foreground'>
                    ...
                    {!customer.email && (
                      <span className='ml-1'>
                        but no email on record. This will be saved.
                      </span>
                    )}
                  </p>
              ...
              <div className='grid gap-2'>
                ...
                {customer ? (
                  <p className='text-xs text-muted-foreground'>
                    ...
                    {!customer.phone && (
                      <span className='ml-1'>
                        but no phone on record. This will be saved.
                      </span>
                    )}
                  </p>
                ) : customerName && customerName !== 'Guest' ? (
        ...
        <DialogFooter className='flex-col gap-2 sm:flex-row'>
          ...
          <Button
            onClick={
              activeTab === 'email' ? handleSendEmail : handleSendWhatsApp
            }
            disabled={
