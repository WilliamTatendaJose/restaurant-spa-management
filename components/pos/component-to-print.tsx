...
>(
  (
    ...
    useEffect(() => {
      ...
      if (propBusinessSettings) {
        ...
        setBusinessSettings({
          ...
          zimraTaxNumber:
            propBusinessSettings.zimraTaxNumber ||
            process.env.NEXT_PUBLIC_ZIMRA_TAX_NUMBER ||
            '1234567890',
          zimraBusinessType:
            propBusinessSettings.zimraBusinessType || 'HOSPITALITY',
          zimraRegistrationNumber:
            propBusinessSettings.zimraRegistrationNumber || 'REG/2024/001',
        } as BusinessSettings);
        return;
      }
      ...
      async function loadSettings() {
        try {
          ...
          const enhancedSettings = {
            ...settings,
            zimraTaxNumber:
              settings.zimraTaxNumber ||
              process.env.NEXT_PUBLIC_ZIMRA_TAX_NUMBER ||
              '1234567890',
            zimraBusinessType: settings.zimraBusinessType || 'HOSPITALITY',
            zimraRegistrationNumber:
              settings.zimraRegistrationNumber || 'REG/2024/001',
          };
    ...
    return (
      <div
        className='rounded-lg bg-white p-4 text-black shadow-sm print:text-black'
        ref={ref}
        style={{
          width: '100%',
          maxWidth: '350px',
      ...
      >
        ...
        <div className='mb-4 text-center'>
          <h2 className='text-xl font-bold text-black print:text-black'>
            {businessSettings.businessName}
          </h2>
          <p className='text-sm text-black print:text-black'>
        ...
        <div className='mb-4 border-b border-t border-dashed py-2 text-center'>
          <p className='text-xs font-medium text-black print:text-black'>
            ZIMRA TAX INVOICE
          </p>
          {businessSettings.zimraTaxNumber && (
        ...
        <div className='mb-4 text-black print:text-black'>
          ...
          <p className='text-xs'>
            ...
            {transactionType.toUpperCase()} SERVICES
          </p>
        </div>
        ...
        <div className='mb-4 text-black print:text-black'>
          <table
            className='w-full text-sm text-black print:text-black'
          ...
          >
            <thead>
              ...
              >
                <th
                  className='py-1 text-left text-black print:text-black'
                  style={{ textAlign: 'left', padding: '4px 0' }}
                >
                  Item
                </th>
                <th
                  className='py-1 text-center text-black print:text-black'
                  style={{ textAlign: 'center', padding: '4px 0' }}
                >
                  Qty
                </th>
                <th
                  className='py-1 text-right text-black print:text-black'
            ...
            <tbody>
              {items.map((item) => {
                ...
                return (
                  ...
                  >
                    <td
                      className='py-1 text-black print:text-black'
                      style={{ padding: '4px 0' }}
                    >
                      <div>{item.name}</div>
                    </td>
        ...
        <div className='mt-4 text-black print:text-black'>
          <div className='mb-2 border-t pt-2 text-sm font-medium'>
            TAX SUMMARY:
          </div>
          ...
          <div
            className='flex justify-between text-lg font-bold text-black print:text-black'
            style={{
              display: 'flex',
        ...
        <div className='mt-4 text-center'>
          ...
          <p className='mt-1 text-xs text-black print:text-black'>
        ...
        <div className='mt-4 border-t pt-2 text-center'>
          <p className='mb-1 text-xs font-medium text-black print:text-black'>
          ...
          {displayQrCode ? (
            ...
            <div className='mx-auto my-2 flex h-24 w-24 items-center justify-center border border-dashed border-gray-400'>
              <span className='text-xs'>QR</span>
            </div>
          )}

          <div className='mt-1 text-xs text-black print:text-black'>
            <p>Transaction: {transactionId.substring(0, 8)}</p>
            {zimraReference && (
              <p>ZIMRA Verified - Ref: {zimraReference.substring(0, 8)}</p>
            )}
          </div>
        </div>
      </div>
